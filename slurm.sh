...
#SBATCH --job-name=hn_train   # sensible name for the job
...
singularity exec --nv deoxys-new.sif python experiment.py $1 $HOME/hnperf/$2 --temp_folder $SCRATCH/hnperf/$2 --analysis_folder $SCRATCH/analysis/$2 --epochs $3 ${@:4}
